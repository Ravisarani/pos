...
public class main extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        try {
            if (fr1!=null) {
                fr1.jTextField1.setText("Hiiiii");
            }
            
            if (fr2!=null) {
                fr2.jTextField1.setText("SSSSS");
            }
//                frame_01 fr = new frame_01();
//                new frame_01().setVisible(true);
//                fr.jTextField1.setText("ravisaranita pissu");
        } catch (Exception e) {
            e.printStackTrace();
        }
